...
PowerMonitorData PowerMonitorInterface::getData(){
	...
	retval.voltage = (float)(voltRaw>>4) * (25.0/1000.0); //25mV to convert to V
	retval.current = (float)(currRaw>>4) *(25.0/1000000.0)*(1/senseR); //25uV * 1/SenseResistor to convert to A

...
#define FILE_HANDLER_DEBUG                      1

#ifdef HOST
const char * writeDir = "/home/fsw-dev/filehandlertest/";
const char * truDat = "/home/fsw-dev/filehandlertest/tru.dat";
#define DEBUG_VAL(m, val) cout << m << ": " << val << endl;
#define DEBUG_COUT(m) cout << m << endl;
#else
#define DEBUG_VAL(m, val)
#define DEBUG_COUT(m)
//TODO: put the correct directories here
const char * writeDir = "/media/card/";
const char * truDat = "/media/card/tru.dat";
#endif

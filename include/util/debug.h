...
#ifndef DEBUG_KERMIT				/* and if DEBUG_KERMIT not already defined */
...
#ifdef DEBUG_KERMIT				/* Debugging included... */
...
/*
  dodebug() is accessed throug a macro that:
   ...
   . Makes it disappear entirely if DEBUG_KERMIT not defined.
*/
#ifdef KERMIT_C

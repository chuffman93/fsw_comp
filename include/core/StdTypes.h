...
{
	EPS_CMD_MIN = 1,
    EPS_HS_CMD = EPS_CMD_MIN,				// valid:	1
    EPS_POWER_CYCLE_CMD, 					// valid:	2
    EPS_SOC_CMD,							// invalid
    EPS_DISABLE_OC_PROT_CMD,				// invalid
    EPS_ENABLE_OC_PROT_CMD,					// invalid
	EPS_POWER_SUB_CMD,						// invalid
	EPS_CMD_MAX,							// invalid

	EPS_HS_SUCCESS = 201,					// valid:	201
	EPS_POWER_CYCLE_SUCCESS,				// valid:	202
	EPS_SOC_SUCCESS,						// invalid
	EPS_DISABLE_OC_PROT_SUCCESS,			// invalid
	EPS_ENABLE_OC_PROT_SUCCESS,				// invalid
	EPS_POWER_SUB_SUCCESS,					// invalid

	EPS_MSG_ERROR_MIN = 101,
	EPS_HS_FAILURE = EPS_MSG_ERROR_MIN,		// valid:	101
	EPS_POWER_CYCLE_FAILURE,				// valid:	102
	EPS_SOC_FAILURE,						// invalid
	EPS_DISABLE_OC_PROT_FAILURE,			// invalid
	EPS_ENABLE_OC_PROT_FAILURE,				// invalid
	EPS_POWER_SUB_FAILURE,					// invalid
	EPS_MSG_ERROR_MAX,						// invalid
